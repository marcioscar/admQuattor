...
export const loader: LoaderFunction = async ({ request }) => {
	...
	const despesas = await getDespesas(String(ano));
	...
	return (
		<>
			...
			<div className='flex justify-around items-center'>
				...
				<NavLink
					className=' flex mr-4  focus:outline-none text-white bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:ring-yellow-300  rounded-lg text-sm px-5 py-2.5  mb-2 dark:focus:ring-yellow-900'
					to='new'>
					Nova
				</NavLink>
			</div>
